...
import { BrandMentionChart, BrandPositionChart, PlatformRatesChart } from "@/components/dashboard-charts";
import { demoEvidence } from "@/lib/demo-data";
import { calculateMetrics, formatPercent, getBatchSummaries, getBrandCompetition, getBrandPositionStackData, getPlatformChartData, getPlatformSummaries } from "@/lib/evidence-analytics";
import { projectConfig } from "@/lib/project-config";

function CompetitionContent() {
  const searchParams = useSearchParams(); const router = useRouter(); const batches = getBatchSummaries(demoEvidence); const batchNames = batches.map((batch) => batch.name);
